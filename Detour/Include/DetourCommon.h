...
template<class T> inline T dtAbs(T a) { return a < T(0) ? -a : a; }
...
inline void dtVcross( Real* dest, const Real* v1, const Real* v2)
{
...
inline Real dtVdot(const Real* v1, const Real* v2)
{
...
inline void dtVmad( Real* dest, const Real* v1, const Real* v2, const Real s)
{
	dest[0] = v1[0]+v2[0]*s;
	dest[1] = v1[1]+v2[1]*s;
	dest[2] = v1[2]+v2[2]*s;
...
inline void dtVlerp( Real* dest, const Real* v1, const Real* v2, const Real t)
{
...
inline void dtVadd( Real* dest, const Real* v1, const Real* v2)
{
	dest[0] = v1[0]+v2[0];
	dest[1] = v1[1]+v2[1];
	dest[2] = v1[2]+v2[2];
...
inline void dtVsub( Real* dest, const Real* v1, const Real* v2)
{
	dest[0] = v1[0]-v2[0];
	dest[1] = v1[1]-v2[1];
	dest[2] = v1[2]-v2[2];
...
inline void dtVscale( Real* dest, const Real* v, const Real t)
{
	dest[0] = v[0]*t;
	dest[1] = v[1]*t;
	dest[2] = v[2]*t;
...
inline void dtVmin( Real* mn, const Real* v)
{
	mn[0] = dtMin(mn[0], v[0]);
	mn[1] = dtMin(mn[1], v[1]);
	mn[2] = dtMin(mn[2], v[2]);
...
///  @param[in]		v	A vector. [(x, y, z)]
inline void dtVmax( Real* mx, const Real* v)
{
	mx[0] = dtMax(mx[0], v[0]);
	mx[1] = dtMax(mx[1], v[1]);
	mx[2] = dtMax(mx[2], v[2]);
...
inline void dtVset( Real* dest, const Real x, const Real y, const Real z)
{
...
inline void dtVcopy( Real* dest, const Real* a)
{
	dest[0] = a[0];
	dest[1] = a[1];
	dest[2] = a[2];
...
inline Real dtVlen(const Real* v)
{
...
inline Real dtVlenSqr(const Real* v)
{
...
inline Real dtVdist(const Real* v1, const Real* v2)
{
	const Real dx = v2[0] - v1[0];
	const Real dy = v2[1] - v1[1];
	const Real dz = v2[2] - v1[2];
...
inline Real dtVdistSqr(const Real* v1, const Real* v2)
{
	const Real dx = v2[0] - v1[0];
	const Real dy = v2[1] - v1[1];
	const Real dz = v2[2] - v1[2];
...
inline Real dtVdist2D(const Real* v1, const Real* v2)
{
	const Real dx = v2[0] - v1[0];
	const Real dz = v2[2] - v1[2];
...
inline Real dtVdist2DSqr(const Real* v1, const Real* v2)
{
	const Real dx = v2[0] - v1[0];
	const Real dz = v2[2] - v1[2];
	return dx*dx + dz*dz;
...
inline void dtVnormalize( Real* v)
{
	Real d = Real ( 1.0f) / dtMathSqrtf(dtSqr(v[0]) + dtSqr(v[1]) + dtSqr(v[2]));
	v[0] *= d;
	v[1] *= d;
	v[2] *= d;
}
...
inline bool dtVequal(const Real* p0, const Real* p1)
{
	static const Real thr = Real( 1.0f / 16384.0f);
	const Real d = dtVdistSqr(p0, p1);
	return d < thr;
}
...
inline bool dtVisfinite(const Real* v)
{
	bool result =
		dtMathIsfinite(v[0]) &&
		dtMathIsfinite(v[1]) &&
...
///  @param[in]		v	A point. [(x, y, z)]
inline bool dtVisfinite2D(const Real* v)
{
...
///
/// The vectors are projected onto the xz-plane, so the y-values are ignored.
inline Real dtVdot2D(const Real* u, const Real* v)
{
...
///
/// The vectors are projected onto the xz-plane, so the y-values are ignored.
inline Real dtVperp2D(const Real* u, const Real* v)
{
...
inline Real dtTriArea2D(const Real* a, const Real* b, const Real* c)
{
	const Real abx = b[0] - a[0];
	const Real abz = b[2] - a[2];
	const Real acx = c[0] - a[0];
	const Real acz = c[2] - a[2];
...
inline bool dtOverlapBounds(const Real* amin, const Real* amax,
...
inline void dtSwapEndian( Real* v)
{
	unsigned char* x = (unsigned char*)v;
	dtSwapByte(x+0, x+3); dtSwapByte(x+1, x+2);
}
