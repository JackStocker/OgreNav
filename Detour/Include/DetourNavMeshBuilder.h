...
struct dtNavMeshCreateParams
{
	...
	const Real* detailVerts;				///< The detail mesh vertices. [Size: 3 * #detailVertsCount] [Unit: wu]
	...
	const Real* offMeshConVerts;
	/// Off-mesh connection radii. [Size: #offMeshConCount] [Unit: wu]
	const Real* offMeshConRad;
	...
	Real bmin[3];			///< The minimum bounds of the tile. [(x, y, z)] [Unit: wu]
	Real bmax[3];			///< The maximum bounds of the tile. [(x, y, z)] [Unit: wu]

	/// @}
	/// @name General Configuration Attributes
	/// @{

	Real walkableHeight;	///< The agent height. [Unit: wu]
	Real walkableRadius;	///< The agent radius. [Unit: wu]
	Real walkableClimb;	///< The agent maximum traversable ledge. (Up/Down) [Unit: wu]
	Real cs;				///< The xz-plane cell size of the polygon mesh. [Limit: > 0] [Unit: wu]
	Real ch;				///< The y-axis cell height of the polygon mesh. [Limit: > 0] [Unit: wu]
